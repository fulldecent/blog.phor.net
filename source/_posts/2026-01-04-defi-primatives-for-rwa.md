...
These nitpicks matter to some people that spent a lot of money on [non-fungible tokens](/nft-contract-before-terra-nullius) (NFTs) representing images.
...
1. Perform snapshot of on-chain token holders, and distribute benefits on-chain to them. (Similar to how [OpenSea broadcasts royalties](/opensea-shared-storefront-backdoor) for NFTs).
