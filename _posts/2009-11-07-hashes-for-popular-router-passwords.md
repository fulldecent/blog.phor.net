...
updates:
  - date: 2026-03-23
    changes: Full password list now embedded directly in this post
comments:
...
Usage: sniff HTTP traffic. Find encoded password. Be a noob and don't know that it is base64 encoded. Paste into Google. Find this page.
...
| dGVjaG5pY2lhbjoyICsgbGFzdCA0IG9mIEF1ZGlvIFNlcnZlciBjaGFzaXMgU2VyaWFsIGNhc2Ut | technician:2 + last 4 of Audio Server chasis Serial case-sensitive + 561384 |
| dGVjaDo= | tech: |
